        ...
        while (true) {
            ...
            switch (cmd[0]) {
                ...
                case "axe":
                    ...
                    virologists.get(cmd[1]).getEquipments().get(0).setUsed(Boolean.parseBoolean(cmd[2]));
                    break;
                case "cape":
                ...
                case "gloves":
                    ...
                    virologists.get(cmd[1]).getEquipments().get(0).setDurability(Integer.parseInt(cmd[2]));
                    break;
                case "beardance":
                ...
                case "move":
                    ...
                    break;
                case "stealEquipment":
                    virologists.get(cmd[1]).stealEquipment(virologists.get(cmd[1]),virologists.get(cmd[1]).getEquipments().get(Integer.parseInt(cmd[3])));
                    break;
                case "stealResource ":
                    //ezt nem értem hogy működik Gabó találd majd ki
                    virologists.get(cmd[1]).stealResources(virologists.get(cmd[1]),virologists.get(cmd[1]).getResources().get(Integer.parseInt(cmd[3])));
                    break;
                case "useAgent":
                    virologists.get(cmd[1]).useAgent(virologists.get(cmd[1]),virologists.get(cmd[1]).getAgents().get(Integer.parseInt(cmd[3])));
                    break;
                case "craftAgent":
                    switch (cmd[2]) {
